...
OBJCOPY="${OBJCOPY:-tricore-elf-objcopy}"
...
# Generate a temporary file name for the modified and final ELF
MODIFIED_ELF=$(mktemp /tmp/modified.XXXXXX.elf)
FINAL_ELF=$(mktemp /tmp/final.XXXXXX.elf)
